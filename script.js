...
const events = [
  ...
  who: "LMSY",
  category: "Special event",
  title_en: "Japan Expo Thailand 2026 (World of T-Pop) Post event gathering activity",
  title_th: "JAPAN EXPO THAILAND 2026 (WORLD OF T-POP!) กิจกรรมรวมพลหลังเลิกงาน",
  title_zh: "日本博览会泰国 2026（World of T-Pop）活动结束后见面会",
  location_en: "centralwOrld, Bangkok",
  location_th: "centralwOrld, กรุงเทพฯ",
  location_zh: "曼谷 centralwOrld",
