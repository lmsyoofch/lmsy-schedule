...
const events = [
  ...
  startTime: "14:00",
  timezone: "GMT+7",
  notes_en: "Award ceremony recognising contributions to Thai–Japanese cultural relations · Japan Expo Thailand 2026",
  notes_th: "พิธีมอบรางวัลเพื่อยกย่องผู้ส่งเสริมความสัมพันธ์ไทย–ญี่ปุ่น · งาน Japan Expo Thailand 2026",
  notes_zh: "表彰推动泰日文化交流的颁奖仪式 · Japan Expo Thailand 2026",
  tags: ["LMSY", "Award"],
  hashtags: []
},
   {
